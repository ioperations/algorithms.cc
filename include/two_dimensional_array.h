...
class Two_dimensional_array {
   ...
   private:
    ...
    Two_dimensional_array(T* const begin, size_t rows, size_t columns,
                          size_t size)
        : rows_count_(rows),
   ...
   public:
    ...
    Two_dimensional_array(Two_dimensional_array&& o)
        : Two_dimensional_array(o.begin_, o.rows_count_, o.columns_count_,
                                o.size_) {
        o.begin_ = nullptr;
    }
    ...
    T& get(size_t row, size_t column) {
        return const_cast<T&>(
            static_cast<const Two_dimensional_array&>(*this).get(row, column));
    }
...
class Two_dimensional_array<T>::Row {
   ...
   public:
    ...
    value_type& operator[](size_t index) { return *(begin_ + index); }
};
...
class Two_dimensional_array<T>::Row<T_is_const>::Iterator {
   ...
   public:
    ...
    Row::value_type& operator[](size_t index) { return row_[index]; }
};
