...
class Map_printer_node_handler : public Binary_tree_printer_node_handler<typename Map<K, V>::Node> {
    public:
        using node_type = typename Map<K, V>::node_type;
        std::string node_to_string(const node_type& n) {
            std::stringstream ss;
...
template<typename K, typename V>
class Map_printer : 
    public Tree_printer<Binary_tree_node<typename Map<K, V>::Node>, Map_printer_node_handler<K, V>> {
        private:
            using Base = Tree_printer<Binary_tree_node<typename Map<K, V>::Node>, Map_printer_node_handler<K, V>>;
        public:
