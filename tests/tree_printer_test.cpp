...
111  112  113  121  122  131  132  133
    ...
    n = {1, nodes::build_array(
                ...
                node(12,
                     nodes::build_array(
                         121, node(122, nodes::build_array(1221, 1222, 1223)))),
                node(13, nodes::build_array(
                             node(131, nodes::build_array(1311, 1312, 1313)),
                             node(132, nodes::build_array(1321, 1322)), 133)))};
    ASSERT_EQ(to_string(n), R"(
                            1
      ┌────────────┬────────┴────────────────────┐
     11           12                            13
...
TEST(Tree_printer_test, binary_tree) {
    ...
    node n = {
        ...
        new node(12, nullptr, new node(122, nullptr, new node(1222))),
    };
    ASSERT_EQ(to_string(n), R"(
       1
  ┌────┴───┐
...
┌─┴─┐   ┌──┴─┐
 ...
 ┌──┴─┐   ┌──┴─┐
    ...
    n = {
        1,
        new node(11, nullptr, new node(112, new node(1121), new node(1122))),
        new node(12, nullptr, new node(122, new node(1221), new node(1222))),
    };
    ASSERT_EQ(to_string(n), R"(
        1
   ┌────┴────┐
