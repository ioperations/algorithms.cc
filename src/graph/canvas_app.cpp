...
class Canvas_widget : public wxWindow {
   public:
    Canvas_widget(wxWindow* parent, Drawable* const drawable,
...
bool Canvas_application_base::OnInit() {
    ...
    class Canvas_panel : public wxScrolled<wxPanel> {
       public:
        Canvas_panel(wxWindow* parent, Drawable* const drawable)
    ...
    class Main_frame : public wxFrame {
       public:
        Main_frame(Canvas_application_base* const application,
                   Drawable* const drawable, const wxString& title,
